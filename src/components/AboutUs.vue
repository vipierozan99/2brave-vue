<template>
  <div id="AboutUs" :style="{'background-image': 'url(' +images.background+ ')'}">
    <v-layout
      row
      wrap
      style="margin: 0 10px 30px 10px;align-items:flex-start;align-content:flex-start;"
    >
      <v-flex sm6>
        <div
          class="title font-weight-light"
          style="text-align:center;padding:30px 0 90px 0;color:silver"
        >
          <h2 class="display-2" style="color:white">SOBRE NÓS</h2>
          <br>
          <span style="line-height:1.5">
            Nascemos com um propósito: ajudar mulheres vítimas de
            qualquer tipo de violência o que fazer com os seus direitos...
        ...
        <div
          class="title font-weight-light"
          style="text-align:center;padding:0 0 30px 0;color:silver"
        >
          <h2 class="display-2" style="color:white">PLATAFORMA 2BRAVE</h2>
          <br>
          <span style="line-height:1.5">
      ...
      <v-flex sm6>
        <v-img
          @click="redirect('https://hackathon-law.firebaseapp.com/')"
          contain
          style="marign:auto; background:rgba(0,0,0,0)"
          :src="images.postIt"
          width="auto"
          height="380px"
        />
        <div
          class="title font-weight-light"
          style="text-align:center;padding:30px 0 30px 0;color:silver"
        >
